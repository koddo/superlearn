...
alter database thedb owner to admin_role;
...
alter database thedb set search_path to app, misc;
...
------------------------------------------------------------
grant all on database thedb to admin_role;
grant connect on database thedb to client_role;
grant usage on schema app to client_role;
------------------------------------------------------------
revoke all on database thedb from public cascade;
